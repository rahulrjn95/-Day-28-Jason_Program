...
public class AddressBookMain {
    ...
    private class JsonMappingException extends Exception {
    }

    private class ObjectMapper {
        public void writeValue(File file, List<personDetails> addressBook) {
        }

        public personDetails[] readValue(File file, Class<personDetails[]> aClass) {

            return new personDetails[0];
        }
    }
}
